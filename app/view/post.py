...
from app.model.models import User, Post, Category
from app.form.forms import PostForm, OperateForm, CreateCategoryForm
...
def posts():
    ...
    pagination = posts.order_by(Post.publish_time.desc()).paginate(page=page, per_page=5)
...
def create_post():
    ...
    return flask.render_template('create.html', form=post_form, post=None, create_category_form=create_category_form)
...
def edit_post(post_slug):
    ...
    return flask.render_template('create.html', form=post_form, post=search_post, create_category_form=create_category_form)
